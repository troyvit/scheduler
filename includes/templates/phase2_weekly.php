		...
		$extra_event_class = '';
                foreach($e[$check_event] as $val) {
                    ...
                    if($privgroup=='private') {
                        ...
                        $display_events.= '<div class="detail_container" 
                            id = "detail_'.$id.'_'.$private_event_daytime_id.'"></div>
                            <div style="'.$extra_event_style.'" 
                            sfs_id = "'.$id.'_'.$private_event_daytime_id.'" 
                            class="event_daily_display '.$extra_event_class.' '.$location_class.'" id="'.$id.':'.$private_event_daytime_id.'" >
                            PRVT<br>
                            '.$participant_fullname.'<br>'.$location.'
                            </div>&nbsp;';
                        ...
                        $display_events.= '
                            ...
                            <div style="'.$extra_event_style.'" class="event_daily_display 
'.$extra_event_class.'" id="'.$id.'" >'.$et_code.'<br>'.$location.' 
<br> '.$fname.'<input type="hidden" class="cascade_edt_id" value="'.$edt_id.'"></div>&nbsp;';
                    }
                    $event_increment++;
                }
