...
//
$sd['Monday']    = date('U-n-j-Y', mktime (0,0,0, 5, 30, 2016));
$sd['Tuesday']   = date('U-n-j-Y', mktime (0,0,0, 5, 31, 2016));
$sd['Wednesday'] = date('U-n-j-Y', mktime (0,0,0, 6, 1, 2016));
$sd['Thursday']  = date('U-n-j-Y', mktime (0,0,0, 6, 2, 2016));
$sd['Friday']    = date('U-n-j-Y', mktime (0,0,0, 6, 3, 2016));
$sd['Saturday']  = date('U-n-j-Y', mktime (0,0,0, 6, 4, 2016));
$sd['Sunday']    = date('U-n-j-Y', mktime (0,0,0, 6, 5, 2016));
