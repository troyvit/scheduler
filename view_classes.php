...
<title>Swim Float Swim View Classes</title>
...
$(document).ready(function() {
    $.ajax({
        ...
        success: function(result) {
            ...
            console.log('hiding leader_boxes');
            $('#leader_boxes').hide();
            $('#leader_boxes').buttonset();
            $('#leader_boxes input').click(function(e) {
                console.log('you clicked an input');
                leader_filter.filter_on();
            });
            console.log('made tabs down here');
            $( "#classSelectTabs" ).tabs({active: 3});
            $('#classSelectTabs ul li').click(function(e) {
                leader_filter.uncheck_leaders();
                $('#hold_classes').html("");
            });
            $('#participantFilter').click(function(e) {
                // console.log('you are hiding');
                $('#leader_boxes').hide();
            });
            $('#get_events_by_type').click(function(e) {
                console.log('going by type here');
