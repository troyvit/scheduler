...
var enabled=true;
<?php if($_GET['ty']==true) { // better error checking will go here eventually (he said in 2014) ?>
    enabled=false;
<?php } ?>
$(document).ready(function() {
    registration.newGetRegistration("<?php echo $default_reg_id; ?>", "<?php echo $_REQUEST['login_id']; ?>", enabled); 
